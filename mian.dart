...
void main() {
  ...
  DateTime endTime = DateTime(
      now.year, now.month, Duration(days: now.day).inDays, 17, 0, 0);
  ...
  List<String> timeSlots = getSlots(startTime,endTime,step);
...
List<String>  getSlots( startTime,endTime,step){
